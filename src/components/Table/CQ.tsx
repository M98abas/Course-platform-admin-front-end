...
import { CQ } from '../../interfaces'
import { useRouter } from 'next/router'

const TableSampleClients = ({ columns }) => {
  const { clients } = useSampleClients(`commonQuestions`)
//  console.log(clients)
...
const handelSelectBtn = async (index: any, cId: any) => {
  ...
  const handelDeleteAction = async () => {
    setLoading(true)
    await ApiDeleteData('commonQuestions', id, (data) => {
      if (!data)
        return (
          <>
...
//    router.reload()
  ...
  const handleModalAction = async () => {
    ...
    try {
      await ApiUpdateData(
        'commonQuestions',
        { id, questionEn, answerEn, questionAr, answerAr },
        (data) => {
      ...
      {!clients ? (
        ...
        <>
                ...
                <div>
                  ...
                  <div>
                    <div className="relative max-w-sm">
                      <input
                        type="text"
                        defaultValue={clients[ind]?.questionAR}
                ...
                <div>
                  ...
                  <div>
                    <div className="relative max-w-sm">
                      <input
                        type="text"
                        defaultValue={clients[ind]?.questionEn}
                ...
                <div>
                  ...
                  <div>
                    <div className="relative max-w-sm">
                      <input
                        type="text"
                        defaultValue={clients[ind]?.answerAR}
          ...
          <table>
            ...
            <tbody>
              {clientsPaginated.map((client: CQ, index: number) => (
                <tr key={client.id}>
                  <td data-label="nickName">{client.questionEn}</td>
                  <td data-label="nickName">{client.questionAR}</td>
                  <td data-label="Name">{client.answerEN}</td>
                  <td data-label="Name">{client.answerAR}</td>
