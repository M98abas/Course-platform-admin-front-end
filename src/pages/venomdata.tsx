...
import TableSampleClients from '../components/Table/venom'
...
const Content = () => {
  const columns: Array<string> = ['traders', 'users', 'leaders', 'actions']
  ...
  const handleModalAction = async () => {
    ...
    await ApiAddData('venomData', { traders, users, toper }, (data) => {
      //console.log(data)
      if (data.errMsg != '')
        return (
          <>
  ...
  return (
    <>
      {!Loading ? (
        <>
          <Head>
            <title>{getPageTitle('Venom Data')}</title>
          </Head>
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiTableBorder} title="Venom Data" main>
              <Button
