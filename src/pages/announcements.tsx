...
import TableSampleClients from '../components/Table/annousments'
...
const Content = () => {
  const columns: Array<string> = ['ImgURL', 'actions']
  ...
  const handleModalAction = async () => {
    ...
    await ApiAddData('annousments', { imgURL }, (data) => {
      if (data.errMsg != '')
        return (
          <>
  ...
  return (
    <>
      {!Loading ? (
        <>
          <Head>
            <title>{getPageTitle('FUDED ACCOUNT Ads')}</title>
          </Head>
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiTableBorder} title="FUDED ACCOUNT Ads" main>
              <Button
