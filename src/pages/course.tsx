...
import TableSampleClients from '../components/Table/courses'
    ...
    <>
      {!Loading ? (
        <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiTableBorder} title="Course" main>
              <Button
                    ...
                    >
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                          <span className="font-semibold">Click to upload course Image</span>
                        </p>
